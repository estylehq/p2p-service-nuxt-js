      ...
      <div class="card">
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs">
            <b-link
              :to="localePath('user-account-withdraw')"
              class="nav-item nav-link"
              router-tag="li"
              active-class="active"
              exact
            >
              {{ $t('user.account.menu-withdraw') }}
            </b-link>
            <b-link
              :to="localePath('user-account-update')"
              class="nav-item nav-link"
              router-tag="li"
              active-class="active"
              exact
            >
              {{ $t('user.account.menu-update') }}
            </b-link>
            <b-link
              :to="localePath('user-account-history')"
              class="nav-item nav-link"
              router-tag="li"
              active-class="active"
              exact
            >
              {{ $t('user.account.menu-history') }}
            </b-link>
          </ul>
        </div>
        <div class="card-body">
