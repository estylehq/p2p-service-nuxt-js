<template>
  <sign-up-base-page :title="$t('sign-up.general')">
    <template #stepper>
      <div class="stepper">
...
export default {
  ...
  methods: {
    ...
    onContactRequest(value) {
      this.contactRequest(value);
    },
    onContactVerify(values) {
